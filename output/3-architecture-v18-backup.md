...
> 版本: v18.0 | 日期: 2026-07-29 | 阶段: docs
>
> **v18.0 变更**: 章节结构专项收敛 —— 原 §11-§19 专题并入 §2 前端架构设计 (降级为 §2.17-§2.25)；一级章节重排为 §1-§14 连续编号，子节编号对齐所属章节；修正 §2.2 重复编号、§3.0 后端修正总览错位 (并入 §3.1)、§7.5/§7.6 可观测性孤儿小节 (移入 §8.5/§8.6)；正文交叉引用与技术债务表引用同步更新。
...
### 2.6 EditorRuntimeState — 运行时状态模型 
